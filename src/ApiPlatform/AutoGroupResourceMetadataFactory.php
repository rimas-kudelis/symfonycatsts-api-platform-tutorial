...
{
    private ResourceMetadataFactoryInterface $decoratedFactory;

    public function __construct(ResourceMetadataFactoryInterface $decoratedFactory)
    {
    ...
    {
        $resourceMetadata = $this->decoratedFactory->create($resourceClass);
